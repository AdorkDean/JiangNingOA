...
//        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"XLScroll友情提醒！" message:@"您填写的按钮数与视图数不一致，请仔细检查代码" preferredStyle:UIAlertControllerStyleAlert];
...
//        UIAlertView *alert =[[UIAlertView alloc]initWithTitle:@"XLScroll友情提醒！" message:@"您填写的按钮数与视图数不一致，请仔细检查代码" delegate:nil cancelButtonTitle:@"好的" otherButtonTitles:nil, nil];
     //   [alert show];
        ...
        self.xl_buttonNames =self.xl_buttonNames?self.xl_buttonNames:@[@"",@"",@""];
...
//滑动头视图
    self.scroll1 =[[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, screen_width, self.xl_topHeight?self.xl_topHeight:65)];
    ...
    if (self.xl_topBackImage) {
        ...
        self.xl_topBackImage = [UIImage imageNamed:@"navi"];
    ...
    for (int i =0; i<self.xl_buttonNames.count; i++) {
        ...
        if (self.xl_buttonNames.count <=5) {
            temp.frame =CGRectMake(screen_width/self.xl_buttonNames.count*i, 5, screen_width/self.xl_buttonNames.count, self.xl_topHeight?self.xl_topHeight:65);
        }else {
            temp.frame =CGRectMake(screen_width/5*i, 5, screen_width/5, self.xl_topHeight?self.xl_topHeight:65);
        }
        temp.titleLabel.font =[UIFont fontWithName:@"迷你简咪咪" size:18];
    ...
    CGSize size0 =[self.xl_buttonNames[0] sizeWithAttributes:@{NSFontAttributeName :[UIFont systemFontOfSize:self.xl_buttonFont?self.xl_buttonFont:20]}];
    ...
    self.view2.backgroundColor =self.xl_sliderColor?self.xl_sliderColor:XHColor(255, 255, 255);
...
-(void)addScroll2{
    //下部滑动视图
    self.scroll2 =[[UIScrollView alloc]initWithFrame:CGRectMake(0, self.xl_topHeight?self.xl_topHeight:65, screen_width, self.frame.size.height -(self.xl_topHeight?self.xl_topHeight:50))];
