...
@interface AssetsChooseViewController ()

@end

@implementation AssetsChooseViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    switch (indexPath.section) {
        case 0:{
            AssetsListViewController *asVC = [AssetsListViewController new];
            [self.navigationController pushViewController:asVC animated:YES];
        }
            break;
        case 1:{
            AuditAssetsListViewController*aslVC = [AuditAssetsListViewController new];
            [self.navigationController pushViewController:aslVC animated:YES];
        }
            break;
        default:
            break;
